                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar-group mt-2">
                                                    <p class="text-s font-weight-bold">{{$community->name}}</p>
                                                </div>
                                            </td>
                                            <td class="align-middle ">
                                                <p class="text-s font-weight-bold">{{$community->age}} </p>
                                            </td>
                                            <td class="align-middle">
                                                <div class="progress-wrapper w-75 mx-auto">
                                                    <div class="progress-info">
                                                        <p class="text-s font-weight-bold">{{$community->hobbies}} </p>
                                                    </div>
                                            ...
                                            <td class="align-middle">
                                                <div class="progress-wrapper w-75 mx-auto">
                                                    <p class="text-s font-weight-bold">{{$community->phone}} </p>
