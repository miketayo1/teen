                        ...
                        <div class="card my-4">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                    <h6 class="text-white text-capitalize ps-3">Events/Shows</h6>
                                </div>
                            </div>
                            <div class="card card-body mx-3 mx-md-4 ">
                                    <div class=" me-3 my-3 text-end">
                                        <a class="btn bg-gradient-dark mb-0" href="{{route('add-event')}}"><i
                                                class="material-icons text-sm">add</i>&nbsp;&nbsp;Add Event
                                        </a>
                                    </div>   
                                <div class="row gx-4 mb-2">
                                    ...
                                    <div class="col-auto my-auto">
                                        <div class="h-100">
                                            <h6 class="mb-1">
                                                <a href="{{ route('get-event') }}">All ({{$events->count()}}) </a> |<a href="{{route('deleted-event')}} "> Trash ({{$trashs}}) </a> 
                                            </h6>
